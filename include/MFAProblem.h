...
public:
	...
	int SteadyStateCommunityModeling(Data* InData, OptimizationParameter* InParameters,bool set_objective_to_total_biomass,double start_kinetic_coef,int iterations,double iteration_size);
